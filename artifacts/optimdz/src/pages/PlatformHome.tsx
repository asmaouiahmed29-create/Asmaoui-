...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    descFr: "Analysez la rentabilité, les flux de trésorerie et les indicateurs financiers de votre entreprise.",
    descAr: "تحليل الربحية والتدفقات النقدية والمؤشرات المالية لمؤسستك.",
    active: false,
    badge: { fr: "Bientôt", ar: "قريباً" },
  },
  {
