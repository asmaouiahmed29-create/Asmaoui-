...
export function DecisionAssistantNavbar() {
    ...
    <header className="border-b bg-background sticky top-0 z-50 shadow-sm" dir={isAr ? "rtl" : "ltr"}>
      <div className="container mx-auto px-4 h-16 flex items-center justify-between max-w-6xl">
        ...
        <div className="flex items-center gap-1 min-w-0">
          ...
          >
            {t("Assistant de Décision", "مساعد القرار")}
          </Link>
          ...
          {tool && (
            <>
              ...
              <span className="hidden md:inline text-xs font-semibold border border-primary/30 bg-primary/5 text-primary rounded-md px-2 py-0.5 ms-0.5">
...
export function DecisionAssistantLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-[100dvh] flex flex-col bg-muted/20">
      <DecisionAssistantNavbar />
